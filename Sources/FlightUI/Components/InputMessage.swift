...
struct InputMessage_Previews: PreviewProvider {
    ...
    static var previews: some View {
        VStack {
            ...
            .environmentObject(Theme(validationStatusWarning: .flightRed, validationStatusCaution: .flightOrange, validationStatusAdvisory: .flightWhite))
            ...
            .environmentObject(Theme(validationStatusWarning: .flightGreen,
                                     validationStatusCaution: .flightBlue,
                                     validationStatusAdvisory: .flightLightGray))
        }
    }
}
