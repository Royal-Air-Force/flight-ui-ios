...
class InputsViewModel: ObservableObject {
...
extension InputsViewModel {
    ...
    enum UnboundDefaultSelectionTypes: UnboundSelectionEnum {
        static var allCases: [InputsViewModel.UnboundDefaultSelectionTypes] {
        ...
        static func custom(string: String) -> InputsViewModel.UnboundDefaultSelectionTypes {
